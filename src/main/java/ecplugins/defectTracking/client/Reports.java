    ...
    extends ComponentBase
{
    ...
    @Override public Widget doInit()
    {
        ...
        Widget htmlH1 = new HTML("<h1>Bugzilla Defects</h1>");

        vPanel.add(htmlH1);

        // Label label = new Label("Bugzilla defects associated with the
        // ElectricCommander job:");
        Widget htmlLabel = new HTML(
                "<p><b>Bugzilla defects associated with the ElectricCommander job:</b></p>");
        ...
        vPanel.add(new HTML(
                "<p><b>Bugzilla updated defects associated with the ElectricCommander job:</b></p>"));
        ...
        vPanel.add(new HTML(
                "<p><b>Bugzilla created defects associated with the ElectricCommander job:</b></p>"));
            ...
            final FormTable      formTable)
    {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "Bugzilla Reports doInit: setting up getProperties command request");
        }
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "Bugzilla Reports doInit: Issuing Commander request: "
        ...
        fileDefectButton.addClickHandler(new ClickHandler() {
                ...
                public void onClick(ClickEvent event)
                {
                    ...
                    request.setProjectName(
                            "/plugins/EC-DefectTracking-Bugzilla/project")
